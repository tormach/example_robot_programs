...
def save_metadata(_final_paths, _non_mirror_final_paths):
    ...
    save_pathsList_to_JSON_file(_non_mirror_final_paths, "non_mirror_pathsMap_extract.json")
...
def init_setup():
    ...
    try:
        ...
        notify("User frame \""+str(USER_FRAME)+"\" Not Found\n"+ "\nPlease create a user frame called \""+str(USER_FRAME)+"\"", error=True)
