...
def main():
    ...
    if (waypoint_1 == None and waypoint_2 == None and waypoint_3 == None): # If nothing was saved ...
        ...
        notify("No waypoints were found, so we will create new ones and save them.", warning=True)
        ...
        notify("Waypoints have been created and saved.\nClick \"OK\" to draw them", warning=True)
    else:
        notify("It looks like you saved some waypoints.\n\nThe saved waypoints have been retrieved and are ready to be ran:\n\nwaypoint_1:\n"+str(waypoint_1)+"\n\nwaypoint_2:\n"+str(waypoint_2)+"\n\nwaypoint_3:\n"+str(waypoint_3) +"\n\n Click \"OK\" to draw the waypoints", warning=True)
